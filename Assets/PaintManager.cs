...
public class PaintManager : MonoBehaviour {
    ...
    public GameObject fadedReticle;
	...
	public void TogglePaint() {
        ...
        if (paintingOn){
            ...
            paintButton.transform.localScale = new Vector3(1.25f, 1.25f, 1.25f);
            reticle.SetActive(true);
            //fadedReticle.SetActive(false);
            brushParent.SetActive(true);
            brush.enableEmission = true;
        } else {
            theFlame.SetActive(false);
            paintButton.transform.localScale = new Vector3(1f, 1f, 1f);
            reticle.SetActive(false);
            //fadedReticle.SetActive(true);
            //brushParent.SetActive(false);
            brush.enableEmission = false;
        }
